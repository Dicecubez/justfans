...
! function(t, e) {
    ...
    return function(t) {
        ...
        var H = function(t) {
                function e(e, n) {
                    return t.call(this, setTimeout, I, e, (function(t) {
                        return n(), null
                    })) || this
                }
                return D(e, t), e
                ...
                return t.prototype.add = function(t, e) {
                    return this.channels[t] || (this.channels[t] = function(t, e) {
                        if (0 === t.indexOf("private-encrypted-")) {
                            if (e.config.nacl) return $t.createEncryptedChannel(t, e, e.config.nacl);
                        ...
                        if (0 === t.indexOf("private-")) return $t.createPrivateChannel(t, e);
                        if (0 === t.indexOf("presence-")) return $t.createPresenceChannel(t, e);
                        if (0 === t.indexOf("#")) throw new y('Cannot create a channel with name "' + t + '".');
                        return $t.createChannel(t, e)
                    }(t, e)), this.channels[t]
            ...
            return t.prototype.isSupported = function() {
                ...
                var s = U.now(),
                    c = o.pop().connect(t, (function r(i, a) {
                        i ? (oe(n), o.length > 0 ? (s = U.now(), c = o.pop().connect(t, r)) : e(i)) : (! function(t, e, n) {
        ...
        var ue, he = function(t, e, n) {
                ...
                var i, s = Object.assign({}, e, {
                    ...
                    _ = new Zt([f], u),
                    w = new Zt([d], u),
                    S = new Zt([new se(ae(y), y, g)], u),
                    k = new Zt([new se(ae(v), v, b)], u),
                    C = new Zt([new se(ae(S), new te([S, new ie(k, {
                        delay: 4e3
                    })]), k)], u),
                    T = new se(ae(C), C, w);
                return i = e.useTLS ? new te([m, new ie(T, {
                    delay: 2e3
                })]) : new te([m, new ie(_, {
                    delay: 2e3
                }), new ie(T, {
                    delay: 5e3
                })]), new ne(new ce(new se(ae(l), i, T)), r, {
                    ttl: 18e5,
                    timeline: e.timeline,
                    useTLS: e.useTLS
                })
        ...
        var be, me = function() {
                ...
                return t.prototype.send = function(t) {
                    ...
                    try {
                        return Ce.createSocketRequest("POST", ge((e = this.location, n = this.session, e.base + "/" + n + "/xhr_send"))).start(t), !0
                    } catch (t) {
                        return !1
                    }
                    var e, n
                    ...
                    this.readyState === de.OPEN && this.onmessage && this.onmessage({
                        data: t
                    })
                    ...
                    var t = this;
                    this.stream = Ce.createSocketRequest("POST", ge(this.hooks.getReceiveURL(this.location, this.session))), this.stream.bind("chunk", (function(e) {
                        t.onChunk(e)
        ...
        var Te = be,
            ...
            Oe = function() {
                ...
                return t.prototype.isSupported = function() {
                    ...
                    if (this.priority < t) return Ee(new v, e);
                    var r = !1,
                        ...
                        c = function() {
                            i = $t.createHandshake(o, (function(t) {
                                r = !0, h(), e(null, t)
                            }))
                        },
                        a = function(t) {
        ...
        var Ae = Ce.Transports,
            xe = function(t, e, n, r, o, i) {
                ...
                }, o), s = new Oe(e, r, i ? i.getAssistant(c) : c, o)) : s = Le, s
            },
            Le = {
                isSupported: function() {
                    return !1
        ...
        function Ne(t) {
            return t.wsHost ? t.wsHost : t.cluster ? He(t.cluster) : He(s.cluster)
        }
        ...
        function ze(t) {
            var e = De({}, s.userAuthentication, t.userAuthentication);
        ...
        function qe(t, e) {
            var n = function(t, e) {
                var n;
                return "channelAuthorization" in t ? n = De({}, s.channelAuthorization, t.channelAuthorization) : (n = {
        ...
        var Be = function() {
            ...
            Xe = function(t) {
                ...
                return Fe(e, t), e.prototype.signin = function() {
            ...
            Je = function() {
                function t(e, n) {
                    ...
                    this.connection = $t.createConnectionManager(this.key, {
                    ...
                    }), this.user = new Xe(this), t.isReady && this.connect()
                }
